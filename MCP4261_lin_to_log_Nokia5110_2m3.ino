...
//  display.setContrast(100);
 display.setContrast(50);  // optimal 50-70
  ...
  display.print("MCP4261-502EP");  
  display.setCursor(0, 30);
  display.print("lin & log pot");
...
display.setTextSize(1);
  for (int i=0; i < 16; i+=1) {
    display.drawLine(40, i, display.width(), i, WHITE);
//    display.display();
  }
...
//  display.drawLine(procent/1.5, display.height(), procent/1.5, display.height()-Voltage0/3, BLACK);
  display.drawPixel(procent/1.5, display.height()-procent/3, BLACK);
  display.drawPixel(procent/1.5, display.height()-Voltage0/3, BLACK);
